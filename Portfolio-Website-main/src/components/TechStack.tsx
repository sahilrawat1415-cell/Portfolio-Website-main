...
const textures = techStack.map((url) => textureLoader.load(url));

const sphereGeometry = new THREE.SphereGeometry(1, 32, 32);

const spheres = [...Array(9)].map((_val, index) => ({
  scale: [0.8, 1, 0.9, 1, 0.85][index % 5],
}));
...
function SphereGeo({
  ...
  // Spread spheres out properly so they don't cluster
  const startX = (index % 3) * 4 - 4;
  const startY = Math.floor(index / 3) * 4 - 4;
  const startZ = r(4);
...
const TechStack = () => {
  ...
  return (
    <div className="techstack">
      ...
      {/* Clean text-based tech stack for recruiters */}
        ...
        <div className="techstack-groups">
          <div className="techstack-group">
            ...
            <div className="techstack-chips">
              ...
              <span className="tech-chip">Matplotlib</span>
              <span className="tech-chip">Seaborn</span>
          ...
          <div className="techstack-group">
            ...
            <div className="techstack-chips">
              ...
              <span className="tech-chip">Jupyter Notebook</span>
